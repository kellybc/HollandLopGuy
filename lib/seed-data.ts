...
export const courses: Course[] = [
  { id: 'c1', prefix: 'MEEN', number: '221', title: 'Statics', program: 'Mechanical Engineering', credit_hours: 3, default_workload_units: 3, annual_sections_required: 2, is_required: true, normally_offered_fall: true, normally_offered_winter: true, normally_offered_spring: false, normally_offered_summer: false, active: true },
  ...
  { id: 'c4', prefix: 'MEEN', number: '382', title: 'Fluids Lab', program: 'Mechanical Engineering', credit_hours: 3, default_workload_units: 4, annual_sections_required: 2, is_required: true, normally_offered_fall: false, normally_offered_winter: true, normally_offered_spring: false, normally_offered_summer: false, active: true },
  ...
  { id: 'c14', prefix: 'ICET', number: '220', title: 'PLC Fundamentals', program: 'ICET', credit_hours: 4, default_workload_units: 4, annual_sections_required: 2, is_required: true, normally_offered_fall: false, normally_offered_winter: true, normally_offered_spring: false, normally_offered_summer: false, active: true },
...
export const initialAssignments: WorkloadAssignment[] = [
  { id: 'w1', faculty_id: 'f1', scenario_id: 'sc-base', academic_year: '2026-2027', quarter: 'Fall', item_type: 'course', course_id: 'c5', activity_id: null, workload_units: 3, workload_units_override: false, credit_hours_snapshot: 3, section: 1, label: 'MEEN 462 Machine Design', status: 'confirmed', created_at: '2026-04-01', updated_at: '2026-04-01' },
  { id: 'w2', faculty_id: 'f1', scenario_id: 'sc-base', academic_year: '2026-2027', quarter: 'Fall', item_type: 'activity', course_id: null, activity_id: 'a2', workload_units: 6, workload_units_override: false, credit_hours_snapshot: null, section: null, label: 'Program Chair Duties', status: 'planned', created_at: '2026-04-01', updated_at: '2026-04-01' },
  { id: 'w3', faculty_id: 'f2', scenario_id: 'sc-base', academic_year: '2026-2027', quarter: 'Winter', item_type: 'course', course_id: 'c4', activity_id: null, workload_units: 4, workload_units_override: true, credit_hours_snapshot: 3, section: 1, label: 'MEEN 382 Fluids Lab', status: 'planned', created_at: '2026-04-01', updated_at: '2026-04-01' },
  { id: 'w4', faculty_id: 'f4', scenario_id: 'sc-base', academic_year: '2026-2027', quarter: 'Winter', item_type: 'course', course_id: 'c14', activity_id: null, workload_units: 4, workload_units_override: false, credit_hours_snapshot: 4, section: 1, label: 'ICET 220 PLC Fundamentals', status: 'confirmed', created_at: '2026-04-01', updated_at: '2026-04-01' },
  { id: 'w5', faculty_id: 'f5', scenario_id: 'sc-base', academic_year: '2026-2027', quarter: 'Spring', item_type: 'course', course_id: 'c20', activity_id: null, workload_units: 3, workload_units_override: false, credit_hours_snapshot: 2, section: 1, label: 'ICET 410 Senior Project', status: 'planned', created_at: '2026-04-01', updated_at: '2026-04-01' },
  { id: 'w6', faculty_id: 'f3', scenario_id: 'sc-base', academic_year: '2026-2027', quarter: 'Spring', item_type: 'activity', course_id: null, activity_id: 'a1', workload_units: 3, workload_units_override: false, credit_hours_snapshot: null, section: null, label: 'Research', status: 'planned', created_at: '2026-04-01', updated_at: '2026-04-01' }
];
